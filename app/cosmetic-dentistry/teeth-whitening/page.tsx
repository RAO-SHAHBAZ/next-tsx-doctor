...
export default function TeethWhiteningPage() {
  const faqsTeethWhitening = [
    ...
    },
    {
      ...
      answer:
        "A qualified dentist provides safe and successful teeth whitening services.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "You will not harm your enamel during teeth whitening from a dentist.",
    },
    {
      question:
        "Does the teeth whitening process allow for multiple distinct shades of lightening?",
      answer:
        "The whitening process produces shade alteration between 3 and 8 levels.",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-8 mb-20">
        <div className="flex flex-col-reverse lg:flex-row gap-8">
          ...
          <main className="w-full lg:w-3/4 flex flex-col gap-6">
            <img
              src="/cosmetic-dentistry/Teeth Whitening/Teeth Whitening.webp"
              alt="Teeth Whitening"
            ...
            <div>
              ...
              <h2 className="text-2xl lg:text-left text-center mb-2">
                Achieve a Dazzling, White Smile with Professional Teeth
                Whitening
              </h2>
              <p className=" leading-relaxed">
                The Edinburgh practice of City Dental Care provides patients
                with safe, efficient, and rapid teeth-whitening procedures. Our
                treatments are ideal for people who have staining or wish to
                brighten their smiles. Your smile will become brighter through
                our treatments regardless of staining from food consumption,
                drinks, or natural ageing processes.
              </p>
            </div>
            ...
            <div className="bg-[#F5F5F5] p-10">
              ...
              <p>
                Our City Dental Care has the best, advanced whitening
                technology, and it is safe and effective. Here's how the process
                works:
              </p>
              <br />
              {[
            ...
            <img
              src="/cosmetic-dentistry/Teeth Whitening/Teeth Whitening 2.webp"
              alt="Teeth Whitening"
              className="rounded-2xl w-full max-h-[500px] object-cover"
            />
            <div>
            ...
            <div className="bg-[#F5F5F5] p-10">
              ...
              <p>
                The longstanding experience of City Dental Care in cosmetic
                dentistry makes the clinic Edinburgh's prime choice for secure
                and effective teeth whitening services. Our professional staff
                employs modern technological equipment with advanced methods to
                deliver the optimum outcomes.
              </p>
              <br />
              {[
                {
            ...
            <p>
              Are you looking to get a sparkling white smile? If you visit the
              City Dental Care Clinic, you can do it orally. There is no reason
              to wait any longer to bring out your best smile and feel confident
              about your teeth whitening. If you are in Edinburgh, plan a visit
              to City Dental Care and speak to us about planning your perfect
              smile transformation today.
            </p>
