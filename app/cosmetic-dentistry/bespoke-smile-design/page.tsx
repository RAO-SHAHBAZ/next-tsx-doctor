...
export default function BespokeSmileDesign() {
  const faqs = [
    ...
    {
      question:
        "How does Bespoke Smile Design come about during the consultation?",
      answer:
          ...
          <main className="w-full lg:w-3/4 flex flex-col gap-6">
            ...
            <div>
              ...
              <p className=" leading-relaxed">
                You have set your smile as unique simply because you are special
                at City Dental Care Edinburgh. Bespoke Smile Design offers the
                optimal way of improving your appearance and giving you a unique
                smile. For anyone wanting minor changes or a comprehensive
                reddening of the smile, our professional dentists implement
                procedures that fit the latest trends and technology to provide
                a beautiful smile design that complements your facial structure
                and dental anatomy.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Cosmetic dentistry or bespoke smile design refers to teeth
                enhancement through a smile design that fits the client's
                requirements. Our dentists take images and apply pretreatment
                planning to strengthen the odds that the best smile designs will
                fit the face of the person receiving it. Whether you require
                treatment of spacing, misalignment, or stains, each smile aspect
                is planned meticulously for beauty and realism.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Every aspect of the Bespoke Smile Design process is a simple,
            ...
            <div className="bg-[#F5F5F5] p-10">
              ...
              <p>
                Cosmetic dentistry in Edinburgh has built City Dental Care a
                reputation for excellence throughout the city. That is why our
                patients trust us to transform their smiles.
              </p>
              {[
                {
