...
export default function InvisibleFillings() {
  const faqsInvisibleFillings = [
    {
      question:
        "How do invisible fillings maintain their invisible characteristics?",
      answer:
    ...
    {
      question:
        "How many years does a patient need to expect their invisible fillings to remain?",
      answer:
    ...
    {
      question:
        "What is the use of invisible fillings in treating wide cavities?",
      answer:
    ...
    {
      question:
        "Do patients need to take particular care of invisible fillings?",
      answer:
    ...
    {
      question:
        "Do invisible fillings work effectively when treating front teeth?",
      answer:
      ...
      <div className="container mx-auto px-4 py-8 mb-20">
        <div className="flex flex-col-reverse lg:flex-row gap-8">
          ...
          <main className="w-full lg:w-3/4 flex flex-col gap-6">
            <img
              src="/cosmetic-dentistry/Invisible Fillings/Invisible Fillings.jpg"
            ...
            <div>
              ...
              <p className=" leading-relaxed">
                Patients at City Dental Care Edinburgh can obtain invisible
                fillings that deliver both healthy and attractive smiles. The
                dental restoration material employed for these cases uses
                premium tooth-colored substances that replicate the natural
                tooth appearance. Patients receive natural restorations from
                invisible fillings when they need cavity treatments along with
                cosmetic improvement of their smile appearance.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Invisible or composite fillings have been designed to match
                their colour with the teeth's natural appearance. When teeth
                appear in your smile, these fillings serve as the best solution
                for restoration. The substance exhibits durability and lasting
                properties with a natural smooth finish.
              </p>
              <br />
              {[
                {
            ...
            <div className="bg-[#F5F5F5] p-10">
              ...
              <p>
                At City Dental Care, you can find superior personalised
                invisible fillings treatment that leads to long-lasting results.
                Here's why:
              </p>
              <br />
              {[
            ...
            <img
              src="/cosmetic-dentistry/Invisible Fillings/Invisible Fillings 1.jpg"
              alt="Invisible Fillings"
              className="rounded-2xl w-full max-h-[500px] object-cover"
            />
            ...
            <div className="bg-[#F5F5F5] p-10">
              ...
              <br />
              <p>
                The procedure of getting invisible fillings at City Dental Care
                follows a streamlined process that provides stress-free
                treatment.
              </p>
              {[
                {
            ...
            <p>
              Visual tooth restorations at City Dental Care provide an
              attractive smile solution that still maintains a natural
              appearance. The expert team at our Edinburgh location will perform
              a complete tooth restoration using top-quality materials and
              methods.
            </p>
