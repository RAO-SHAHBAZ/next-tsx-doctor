"use client";
 ...
 export default function StainRemoval() {
  const faqsStainRemoval = [
  {
   ...
   answer: "Stain removal typically needs a treatment time of up to an hour.",
  },
  {
   question: "How do Stain removal processes make your teeth whiter?",
   answer: "The treatment can enhance tooth brightness by getting rid of blemishes.",
  },
  {
  ...
  },
  {
   ...
   answer: "The teeth will be brighter, and you will have fresh breath and a clean smile.",
  },
  ];

  return (
  <>
   <BredCrumbServices title="Stain Removal" subtitle={(
    <span>
     ...
     <main className="w-full lg:w-3/4 flex flex-col gap-6">
      ...
      <div>
       ...
       <p className=" leading-relaxed">
        City Dental Care in Edinburgh delivers professional treatments for stain removal that help patients regain their teeth's natural white colour.
        Our quick stain removal service efficiently treats discolouration from coffee, tea, and tobacco staining. You will soon regain a confident smile.
       </p>
      </div>
      ...
      <div>
       ...
       <p >
        What we are known for is using the latest techniques and dental technology to remove stains from your teeth. Here's how the process works:
       </p>
       {[
        {
         title: "Consultation:",
      ...
      <div>
       ...
       <p >
        Our highest priority is your comfort and satisfaction. Our team's use of advanced technology results in safety, effectiveness, and a personalised stain removal experience.
        We need to spend that time getting to know your goals and come up with a treatment plan centred around you.
       </p>
       {[
        {
      ...
      <div className="flex  flex-col items-center">
       <h2 className="text-2xl text-center lg:text-left  mb-2">
        Make your stain removal booking right now at City Dental Care Edinburgh.
       </h2>
       <p >
        Ready for a fresh, bright smile? Call City Dental Care in Edinburgh to secure your professional stain removal appointment right now.
        Our team will help you achieve your dream of a shiny, confident smile.
       </p>
