"use client";
 ...
 export default function FacialAesthetics() {
  const faqsFacialAesthetics = [
  {
   ...
   answer: "It involves altering the appearance of the face through various noninvasive treatments.",
  },
  {
  ...
  {
   question: "How long does one stand to benefit from the given facial aesthetic treatments?",
   answer:
  ...
  {
   question: "Are there any post-operative consequences in the facial aesthetics treatment process?",
   answer:
    "Regardless of skin type, most facial aesthetic treatments do not cause severe reactions in both ladies and gentlemen.",
  },
  {
   question: "Is it safe to perform facial aesthetic treatments along with some other cosmetic treatments?",
   answer:
  ...
  return (
  <>
   <BredCrumbServices title="Facial Aesthetics" subtitle={(
    <span>
     ...
     <main className="w-full lg:w-3/4 flex flex-col gap-6">
      ...
      <div>
       <h1 className="text-4xl lg:text-5xl text-center mb-3 lg:text-left">
        Rejuvenate Your Appearance with Expert Facial Aesthetic Treatments in Edinburgh
       </h1>
       <h2 className="text-2xl lg:text-left text-center mb-2">
        Why Choose Facial Aesthetic Treatments?
       </h2>
       <p className=" leading-relaxed">
        City Dental Care in Edinburgh offers several cosmetic procedures aimed at improving the look of your face and smile.
        Our facial aesthetics treatments offer patients a non-surgical approach to altering and improving facial features such as lines, skin roughness, and wrinkles.
       </p>
       <p className=" leading-relaxed">
        Facial aesthetics offers many benefits, including smoothing wrinkles and improving the contours of the face. For these reasons, you may want to consider it.
       </p>
      </div>
      ...
      <div>
       ...
       <p>
        Improvements in facial aesthetics will immediately improve the texture, tone, and volume of your skin.
        Whether smoothing wrinkles or rejuvenating the complexion, you'll always have a more youthful complexion.
       </p>
      </div>
      ...
      <div>
       ...
       <p>
        Facial aesthetic procedures are noninvasive and do not require surgery. It is ideal for those who want a younger appearance without long periods of recovery.
       </p>
      </div>
      ...
      <div>
       ...
       <p>
        Facial aesthetic treatments provide results that stay effective for months, thus allowing you to regain a firmer, youthful facial appearance.
       </p>
      </div>
      ...
      <div>
       ...
       <p>
        Our procedures at City Dental Care are structured according to the assessed facial characteristics of each patient seeking aesthetic enhancement.
        The clinic's professional staff develops tailored treatments for every patient to emphasise their genuine facial characteristics.
       </p>
      </div>
      ...
      <div>
       ...
       <p >
        Facial aesthetics treatments bring more than skin rejuvenation benefits because they improve the appearance of your smile. Here's how:
       </p>
       {[
        {
        ...
        {
         title: "Facial Treatments Will Increase Volume and Make Your Skin Smoother",
      ...
      <div>
       ...
       <p >
        To this end, we operate under the premise of ensuring that our patients are as comfortable as possible during the dental procedures that they undergo with us.
        All our facial aesthetic treatments are highly effective for the given problem and last long; we provide a relaxing environment.
       </p>
       {[
        {
         title: "Consultation",
      ...
      <div>
       ...
       <p >
        City Dental Care unites its cosmetic dentistry knowledge with facial aesthetics practices to provide exceptional dental outcomes to patients.
        The clinic provides treatments that deliver both inner and outer rejuvenation so you can experience enhanced confidence along with a younger-looking appearance.
        The following reasons demonstrate why City Dental Care serves as your premier option for facial aesthetics across Edinburgh.
       </p>
       {[
        {
      ...
      <div className="flex  flex-col items-center">
       ...
       <p >
        Facial aesthetics treatment is the ideal solution for improving your smile and rejuvenating your face.
        City Dental Care enables patients to receive customised facial aesthetic treatments for improving fine lines, enhancing volume, and defining their jawlines to achieve youthful facial effects.
        Secure your appointment for a consultation, which will lead you to a confident smile with enhanced radiance.
       </p>
