"use client";
 ...
 export default function DermalFillers() {
  ...
  {
   question: "What is the possibility of using dermal fillers with additional cosmetic procedures?",
   answer:
  ...
  },
  {
   ...
   answer: "The procedure causes mild discomfort that the numbing cream successfully reduces.",
  },
  ];

  return (
  <>
   <BredCrumbServices title="Dermal Fillers" subtitle={(
    <span>
     ...
     <main className="w-full lg:w-3/4 flex flex-col gap-6">
      ...
      <div>
       ...
       <p className=" leading-relaxed">
        The personnel at City Dental Care's Edinburgh location deliver dermal filler treatment, which enhances the beauty of a natural smile.
        People select dermal fillers because they deliver a non-surgical treatment option that both removes wrinkles and restores natural facial volume, reducing signs of ageing.
        Dermal fillers provide an excellent avenue for people who want to restore vitality to their look during their smile rejuvenation journey.
       </p>
      </div>
      ...
      <div>
       ...
       <p >
        Not only do dermal fillers improve your skin's look, but they also enhance the look of your smile. Here's how:
       </p>
       {[
        {
      ...
      <div>
       ...
       <p >
        The dental practice at City Dental Care guarantees both safety and comfort. The treatment process for dermal fillers functions in the following manner:
       </p>
       {[
        {
         title: "Consultation:",
      ...
      <div>
       ...
       <p >
        City Dental Care unites its cosmetic dentistry knowledge with Dermal filler practices to provide exceptional dental outcomes to patients.
        ...
        The following reasons demonstrate why City Dental Care serves as your premier option for dermal fillers across Edinburgh.
       </p>
       {[
        {
      ...
      <div className="flex  flex-col items-center">
       ...
       <p >
        Dermal fillers are the ideal treatment for enhancing your smile with facial rejuvenation. We offer a range of facial aesthetic treatments for both men and women in Edinburgh.
        At City Dental Care, we aim to provide a first-class service. Visit our clinic now and book a consultation to improve your looks and smile.
       </p>
